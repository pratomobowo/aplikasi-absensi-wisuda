    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 flex-shrink-0">
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="{{ route('admin.layout-wisuda.index') }}"
                   class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg {{ request()->routeIs('admin.layout-wisuda.*') ? 'bg-primary-50 text-primary-700' : 'text-gray-700 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
