            ...
            <div class="flex flex-col lg:flex-row gap-4 items-center justify-between">
                ...
                <div class="relative w-full lg:w-96">
                    <input
                        ...
                        class="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                    >
                ...
                <div class="flex flex-wrap gap-3 items-center w-full lg:w-auto">
                    ...
                    <div class="relative">
                        <select
                            ...
                            class="px-4 py-2.5 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm bg-white @if($selectedProdi) border-blue-500 bg-blue-50 @endif"
                        >
                        ...
                        @if($selectedProdi)
                            <button wire:click="$set('selectedProdi', '')" class="absolute right-8 top-3 text-gray-400 hover:text-gray-600">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        @if($selectedProdi)
                            <span class="inline-flex items-center px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full">
                                Prodi: {{ $selectedProdi }}
                                <button wire:click="$set('selectedProdi', '')" class="ml-1 hover:text-green-600">×</button>
                            </span>
                        @endif
                    </div>
                @endif
