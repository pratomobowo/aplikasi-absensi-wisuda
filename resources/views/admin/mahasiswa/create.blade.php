            ...
            <form action="{{ route('admin.mahasiswa.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Hanya huruf kapital dan angka (contoh: 1112197004)</p>
                    ...
                    <div>
                        ...
                        <input type="text" name="fakultas" value="{{ old('fakultas') }}" required
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
                        @error('fakultas') <p class="text-sm text-red-600 mt-1">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="yudisium" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
                            ...
                            <option value="Cum Laude" {{ old('yudisium') == 'Cum Laude' ? 'selected' : '' }}>Cum Laude (Dengan Pujian)</option>
